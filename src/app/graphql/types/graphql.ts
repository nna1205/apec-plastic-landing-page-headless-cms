...
export type ProductQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductQueryQuery = { __typename?: 'Query', allProducts: Array<{ __typename?: 'ProductRecord', id: string, title: string, url: string, productCategory: { __typename?: 'CategoryRecord', id: string, title: string, url: string }, productImages: Array<{ __typename?: 'AltFileField', id: string, title?: string | null, url: string }> }> };
