...
const documents = {
    ...
    "query Product($id: ItemId, $locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  product(\n    filter: {id: {eq: $id}, title: {isBlank: \"false\"}}\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n  ) {\n    id\n    title\n    description\n    material\n    variant\n    weight\n    packaging\n    retailPrice\n    wholesalePrice\n    dimension {\n      width\n      height\n      length\n    }\n    productImages {\n      id\n      responsiveImage {\n        src\n        srcSet\n        title\n        alt\n        width\n        height\n      }\n    }\n    productCategory {\n      id\n      title\n    }\n  }\n}": types.ProductDocument,
    ...
    "query CompanyProfile($locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  upload(\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n    filter: {id: {eq: \"EbZ9mRzET9aLsMl83Yc3pw\"}}\n  ) {\n    id\n    filename\n    format\n    title\n    url\n  }\n}": types.CompanyProfileDocument,
    "fragment DatoImage on ResponsiveImage {\n  src\n  srcSet\n  base64\n  width\n  height\n  alt\n  title\n}": types.DatoImageFragmentDoc,
    "query Suggestion($query: String!, $locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  allProducts(\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n    first: \"5\"\n    orderBy: title_ASC\n    filter: {OR: [{title: {matches: {pattern: $query, caseSensitive: \"false\"}}}, {description: {matches: {pattern: $query, caseSensitive: \"false\"}}}]}\n  ) {\n    id\n    title\n    description\n    url\n  }\n}": types.SuggestionDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Product($id: ItemId, $locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  product(\n    filter: {id: {eq: $id}, title: {isBlank: \"false\"}}\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n  ) {\n    id\n    title\n    description\n    material\n    variant\n    weight\n    packaging\n    retailPrice\n    wholesalePrice\n    dimension {\n      width\n      height\n      length\n    }\n    productImages {\n      id\n      responsiveImage {\n        src\n        srcSet\n        title\n        alt\n        width\n        height\n      }\n    }\n    productCategory {\n      id\n      title\n    }\n  }\n}"): (typeof documents)["query Product($id: ItemId, $locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  product(\n    filter: {id: {eq: $id}, title: {isBlank: \"false\"}}\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n  ) {\n    id\n    title\n    description\n    material\n    variant\n    weight\n    packaging\n    retailPrice\n    wholesalePrice\n    dimension {\n      width\n      height\n      length\n    }\n    productImages {\n      id\n      responsiveImage {\n        src\n        srcSet\n        title\n        alt\n        width\n        height\n      }\n    }\n    productCategory {\n      id\n      title\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query CompanyProfile($locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  upload(\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n    filter: {id: {eq: \"EbZ9mRzET9aLsMl83Yc3pw\"}}\n  ) {\n    id\n    filename\n    format\n    title\n    url\n  }\n}"): (typeof documents)["query CompanyProfile($locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  upload(\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n    filter: {id: {eq: \"EbZ9mRzET9aLsMl83Yc3pw\"}}\n  ) {\n    id\n    filename\n    format\n    title\n    url\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Suggestion($query: String!, $locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  allProducts(\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n    first: \"5\"\n    orderBy: title_ASC\n    filter: {OR: [{title: {matches: {pattern: $query, caseSensitive: \"false\"}}}, {description: {matches: {pattern: $query, caseSensitive: \"false\"}}}]}\n  ) {\n    id\n    title\n    description\n    url\n  }\n}"): (typeof documents)["query Suggestion($query: String!, $locale: SiteLocale, $fallbackLocale: [SiteLocale!]) {\n  allProducts(\n    locale: $locale\n    fallbackLocales: $fallbackLocale\n    first: \"5\"\n    orderBy: title_ASC\n    filter: {OR: [{title: {matches: {pattern: $query, caseSensitive: \"false\"}}}, {description: {matches: {pattern: $query, caseSensitive: \"false\"}}}]}\n  ) {\n    id\n    title\n    description\n    url\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
